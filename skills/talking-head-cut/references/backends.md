...
1. **默认路线（2026-09-21更新）**：普通单源原速口播与分页重点字幕使用主 Skill 的 [固定流水线](../../video-production/references/stable-talking-head.md)。仅在用户要求复杂动效，或继续既有 Remotion 工程时使用扩展渲染路线。下文是扩展工具的能力参考，不是默认制作步骤。
